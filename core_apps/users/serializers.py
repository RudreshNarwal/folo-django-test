...
class UserSerializer(serializers.ModelSerializer):
	...
	def to_representation(self, instance):  #  representation method -> to add the admin field to the serialized data, and it will only show the admin fields if and only if the user is an admin.
