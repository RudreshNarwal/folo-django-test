...
TRANSUNION_UAT_USERNAME=env("TRANSUNION_UAT_USERNAME")
TRANSUNION_UAT_PASSWORD=env("TRANSUNION_UAT_PASSWORD")
TRANSUNION_UAT_CODE=env("TRANSUNION_UAT_CODE")
TRANSUNION_UAT_INFINITY_CODE=env("TRANSUNION_UAT_INFINITY_CODE")
